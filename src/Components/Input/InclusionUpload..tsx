...
const InclusionUpload = (props: InclusionUploadProps) => {
          ...
          return (
            <View style={styles.container}>
              <View style={styles.idImageContainer}>
                <Image
                  testID='test-inclusion-upload-image'
                  source={uploadedImage}
                  style={styles.idImage}
                />
                <Pressable
                  testID='test-inclusion-upload-btn'
                  style={[
                    styles.editButton,
              ...
              <Text testID='test-inclusion-upload-err-text' style={styles.errorText}>
                {errorMessage}
              </Text>
            </View>
          );
...
export default InclusionUpload;
